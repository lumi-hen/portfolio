...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'fa-lightbulb' : 'fa-moon'
...
modalShopBtns.forEach((modalBtn) => {
  let shop__modal__timeout;
  modalBtn.addEventListener('click', () => {
    modalShop.classList.add('active-modal');

    clearTimeout(shop__modal__timeout);
     shop__modal__timeout = setTimeout(() => {
